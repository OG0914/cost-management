...
exports.createPackagingConfig = (req, res) => {
  try {
    const { model_id, config_name, pc_per_bag, bags_per_box, boxes_per_carton, processes } = req.body;
...
exports.updatePackagingConfig = (req, res) => {
  try {
    const { id } = req.params;
    const { config_name, pc_per_bag, bags_per_box, boxes_per_carton, is_active, processes } = req.body;
